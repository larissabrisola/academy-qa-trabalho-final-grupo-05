...
Quando preencher o formulário com nome com 100 caracteres
    Clica e digita
    ...    ${inputNome}
    ...    IwishyouthebestfortherestofyourlifeFeltsorryforyouwhenlookedinyoureyesbutIneedto confessItoldyouali
...
E preencher o formulário com email contendo 60 caracteres
    ...
    Clica e digita
    ...    ${inputEmail}
    ...    ${parte1}emaillongo${parte2}comexatamente60caracteres${parte3}vaidarcerto${parte4}@gmail.com

Quando preencher o formulário com nome maior que 100 caracteres
    clica e digita
    ...    ${inputNome}
    ...    IwishyouthebestfortherestofyourlifeFeltsorryforyouQuandolookedinyoureyesbutIneedtoconfessItoldyoualiea
