...
describe('Atualizar Filmes', function () {
    ...
    beforeEach(function () {
        cy.createAndLogAdmin('Erikão', faker.internet.exampleEmail(), '123456').then(function (response) {
    ...
    it('Não deve ser possível um usuário comum atualizar filmes', function () {
        cy.createAndLoginUser('Ronaldinho Gaucho', faker.internet.exampleEmail(), '123456').then(function (response) {
    ...
    it('Não deve ser possível um usuário critico atualizar filmes', function () {
        cy.createAndLoginCritic('Michael Jordan', faker.internet.exampleEmail(), '123456').then(function (response) {
            let token = response.token
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Deve ser possível apenas um usuário administrador atualizar filmes', function () {
        cy.createAndLogAdmin('Roger Federer', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Deve ser possível atualizar o título de um filme', function () {
        cy.createAndLogAdmin('Rafael Nadal', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Deve ser possível atualizar o gênero de um filme', function () {
        cy.createAndLogAdmin('Lebron James', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Deve ser possível atualizar a descrição de um filme', function () {
        cy.createAndLogAdmin('Curry', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Deve ser possível atualizar a duração de um filme', function () {
        cy.createAndLogAdmin('Kaka', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Deve ser possível atualizar o ano de lançamento de um filme', function () {
        cy.createAndLogAdmin('Neymar Jr.', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Deve ser possível atualizar a descrição do filme com 500 caracteres', function () {
        ...
        cy.createAndLogAdmin('Hugo', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Não deve ser possível atualizar a descrição do filme com mais de 500 caracteres', function () {
        ...
        cy.createAndLogAdmin('Bolt', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Deve ser possível atualizar o título do filme com 100 caracteres', function () {
        ...
        cy.createAndLogAdmin('Messi', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Não deve ser possível atualizar o título do filme com mais de 100 caracteres', function () {
        ...
        cy.createAndLogAdmin('Marcos Massi', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Deve ser possível atualizar o gênero do filme com 100 caracteres', function () {
        ...
        cy.createAndLogAdmin('Ramon', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Não deve ser possível atualizar o gênero do filme com mais de 100 caracteres', function () {
        ...
        cy.createAndLogAdmin('Rodrigo', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Não deve ser possível atualizar o ano de lançamento do filme anterior a 1985', function () {
        ...
        cy.createAndLogAdmin('Sena', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Deve ser possivel atualizar um filme informando a duração de 1 minuto', function () {
        let duration = 1
        cy.createAndLogAdmin('Tomas Shelby', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Não deve ser possível atualizar um filme informando a duração de menos de 1 minuto', function () {
        let duration = 0.59
        cy.createAndLogAdmin('Arthur Shelby', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Deve ser possivel atualizar um filme informando a duração de 720 horas (43200 minutos)', function () {
        ...
        cy.createAndLogAdmin('Fernando', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
    ...
    it('Não deve ser possível atualizar um filme informando a duração de mais de 720.01 horas (43201 minutos)', function () {
        ...
        cy.createAndLogAdmin('Rick Martin', faker.internet.exampleEmail(), "123456").then(function (response) {
            let token = response.token;
            cy.request({
                method: "PUT",
                url: "movies/" + movieId,
